...
import polars as pl
from backend.services.rag.polars.output_parser import (
    PolarsInstructionParser,
)
from backend.services.rag.polars.polars_prompt import DEFAULT_POLARS_PROMPT
...
class PolarsQueryEngine(BaseQueryEngine):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._response_synthesis_prompt = response_synthesis_prompt or DEFAULT_RESPONSE_SYNTHESIS_PROMPT
